function [ res ] = mCLASAaddMax(A, addMax, Niter, Nf)
%MCLASAADDMAX places addMax additional driver nodes for adjacency matrix
...
for Kp = 1:addMax
    ...
    for f=1:Nf
        ...
        [costv(f), maxv(f), sumv(f)] = getCost(allSensors, alpha, Dmat);
